...
export const Footer = () => {
  return (
    <footer
      className={cn(
        "relative py-10 md:pb-20",
        "drop-shadow-sm drop-shadow-foreground/10 filter",
        "after:absolute after:inset-0 after:-z-1 after:bg-background after:[clip-path:polygon(82%_1%,100%_0,100%_100%,0_100%,0_0)] md:after:[clip-path:polygon(72%_5%,100%_0,100%_100%,0_100%,0_0)]"
      )}
    >
      <div className="">
